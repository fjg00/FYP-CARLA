...
##################################################################################################################################################################################################################################### ICONS CODE(FYP)
            ...
            speed=3.6 * math.sqrt(V.x**2 + V.y**2 + V.z**2)
            saved_points = [steer,throttle,brake,reverse,speed,time_record]
            if parking==1:
                with open('/home/justin/Documents/parking/45.csv', 'a') as f:
                    writer = csv.writer(f)
                    writer.writerow(saved_points)

            else:
                with open('/home/justin/Documents/noparking/45.csv', 'a') as f:
                    writer = csv.writer(f)
                    writer.writerow(saved_points)
