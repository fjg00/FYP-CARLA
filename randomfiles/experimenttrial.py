...
#Jason
    ...
    def parse_events(self, client, world, clock):
        ...
        if (throttleCmd != 0 and self._autopilot_enabled == True):
            self._autopilot_enabled = False
            world.player.set_autopilot(self._autopilot_enabled)
            file1 = open('/home/justin/Desktop/carla/ExperimentData/D30.1.txt', 'a')
            file1.write("Throttle is being applied")
        elif (brakeCmd != 0 and self._autopilot_enabled == True):
            self._autopilot_enabled = False
            world.player.set_autopilot(self._autopilot_enabled)
            file1 = open('/home/justin/Desktop/carla/ExperimentData/D30.1.txt', 'a')
            file1.write("Brake is being applied") 
...
def game_loop(args):
    ...
    try:
        ...
        Traffic_light_2.set_state(carla.TrafficLightState.Green)
        ...
        while True:
            ...
            # if (world.player.get_transform().location.x>-90 and world.player.get_transform().location.x<-67) and (world.player.get_transform().location.y> 2 and world.player.get_transform().location.y< 126):
            #     Traffic_light_1.set_state(carla.TrafficLightState.Red)
            # else:
            #      Traffic_light_1.set_state(carla.TrafficLightState.Green)

            # if (world.player.get_transform().location.x>-23.7 and world.player.get_transform().location.x<13.8) and (world.player.get_transform().location.y> 127 and world.player.get_transform().location.y< 140):
            #     Traffic_light_2.set_state(carla.TrafficLightState.Red)
            # else:
            #      Traffic_light_2.set_state(carla.TrafficLightState.Green)
...
################################################################## 
            ...
            if controller._autopilot_enabled:
                ...
                if (world.player.get_transform().location.x>-130 and world.player.get_transform().location.x<-95 and world.player.get_transform().location.y>-2 and world.player.get_transform().location.y<2): 
                ...
                elif (world.player.get_transform().location.x>163 and world.player.get_transform().location.x<195 and world.player.get_transform().location.y>-209 and world.player.get_transform().location.y<-205):
                ...
                elif (world.player.get_transform().location.y>50 and world.player.get_transform().location.y<130 and world.player.get_transform().location.x>238 and world.player.get_transform().location.x<246):
                ...
                elif (world.player.get_transform().location.x>85 and world.player.get_transform().location.x<135 and world.player.get_transform().location.y>-207 and world.player.get_transform().location.y<-203):
                ...
                elif (world.player.get_transform().location.x>1 and world.player.get_transform().location.x<65 and world.player.get_transform().location.y>-208 and world.player.get_transform().location.y<-206):
                    Timesixthintersection = time.time()                  
                    if boll==-1:
                        #hud.notification("No Pedestrian Detected - No Nearby Vehicle in the Blind Spot - Green Light Detected")
                        boll=1 

                elif (world.player.get_transform().location.x>-150 and world.player.get_transform().location.x<-146 and world.player.get_transform().location.y>-93 and world.player.get_transform().location.y<-5):
                ...
                elif (world.player.get_transform().location.x>-123 and world.player.get_transform().location.x<-95 and world.player.get_transform().location.y>133 and world.player.get_transform().location.y<137):
                    ...
                    if List[10].state== carla.TrafficLightState.Red:
                        ...
                        boll=1 
                #instead of sil
                elif (world.player.get_transform().location.x>-65.7 and world.player.get_transform().location.x<-6.8 and world.player.get_transform().location.y>135 and world.player.get_transform().location.y<136):
                    Timetenthintersection = time.time()                  
                    if Traffic_light_2.state== carla.TrafficLightState.Red:
                        #hud.notification("No Pedestrian Detected - No Nearby Vehicle in the Blind Spot - Red Light Detected")
                        boll=0                    
                    elif Traffic_light_2.state== carla.TrafficLightState.Green:
                        #hud.notification("No Pedestrian Detected - No Nearby Vehicle in the Blind Spot - Green Light Detected")
                        boll=1   

                #instead of sil 2
                elif (world.player.get_transform().location.x>-91 and world.player.get_transform().location.x<-88 and world.player.get_transform().location.y>42 and world.player.get_transform().location.y<127.5):
                    Timetenthintersection = time.time()                  
                    if Traffic_light_1.state== carla.TrafficLightState.Red:
                        #hud.notification("No Pedestrian Detected - No Nearby Vehicle in the Blind Spot - Red Light Detected")
                        boll=0                    
                    elif Traffic_light_1.state== carla.TrafficLightState.Green:
                        #hud.notification("No Pedestrian Detected - No Nearby Vehicle in the Blind Spot - Green Light Detected")
                        boll=1              
...
#####################################################################################################################################################################################################################################
            ...
            # elif (world.player.get_transform().location.x>-85 and world.player.get_transform().location.x<-82 and world.player.get_transform().location.y>90 and world.player.get_transform().location.y<120):
            #     world.player.set_autopilot(True)
            #     controller._autopilot_enabled=True 
                #Traffic_light_1.set_state(carla.TrafficLightState.Green)

            # elif (world.player.get_transform().location.distance(p7.get_transform().location) < 8 or  world.player.get_transform().location.distance(p8.get_transform().location)<8 ) and (time.time()-light_start)<10:
            #     world.player.set_autopilot(True)
            #     world.player.set_autopilot(True)
...
##################################################################################################################################################################################################################################### ICONS CODE(FYP)
            ...
            if controller._autopilot_enabled == False and begin ==0 :
                begin = time.time()    
                begin1 = time.time()    
            elif controller._autopilot_enabled == True :
                total = 0
                begin = 0
                begin1 = 0

            now = time.time()
            # if ((now - begin)>10 and (now - begin)<15 and controller._autopilot_enabled == False ):

            if ((now - begin1)>10 and controller._autopilot_enabled == False and not (world.player.get_transform().location.x>-90 and world.player.get_transform().location.x<-70 and world.player.get_transform().location.y>120 and world.player.get_transform().location.y<150)):
                    try:
                        icon1 = pygame.image.load('/home/justin/Downloads/imagesCARLA/SwitchtoAutopilot.png')
                        # display.blit(icon1, (1550, 1300))    
                        # pygame.display.set_icon(icon1) 
                        rect = icon1.get_rect()
                        rect.center = 900, 500
                        icon1.convert()  
                        display.blit(icon1, rect)
                        Gray = (128, 128, 128)
                        pygame.draw.rect(display, rect, 2) 
                    except:
                        print("")
            try:
                V=world.player.get_velocity()
                speed=3.6 * math.sqrt(V.x**2 + V.y**2 + V.z**2)
                icon1 = pygame.image.load('/home/justin/Downloads/imagesCARLA/numbers/'+str(int(speed))+'.png')
                    # display.blit(icon1, (1550, 1300))    
                        # pygame.display.set_icon(icon1) 
                rect = icon1.get_rect()
                rect.center = 970, 840
                ...
                print("")
            if((now - begin)>15 and controller._autopilot_enabled == False ):
                controller._autopilot_enabled = True
                world.player.set_autopilot(True)
                begin =0          #################fyp bug solved
            #font = pygame.font.Font('freeansbold.ttf', 32)
            # try:
            #     if (time.time() - light_start < 6) and ((world.player.get_transform().location.distance(p4.get_transform().location) > 135 and world.player.get_transform().location.distance(p4.get_transform().location) < 150) or (world.player.get_transform().location.distance(p4.get_transform().location) > 60 and world.player.get_transform().location.distance(p4.get_transform().location) < 115) or  (world.player.get_transform().location.distance(p6.get_transform().location) > 135 and world.player.get_transform().location.distance(p6.get_transform().location) < 150) or (world.player.get_transform().location.distance(p6.get_transform().location) > 60 and world.player.get_transform().location.distance(p6.get_transform().location) < 115)) and (not controller._autopilot_enabled):
                    


            # except:
            #         i="love"         #pygame.display.set_icon(icon) 
