...
##################################################################################################################################################################################################################################### ICONS CODE(FYP)
            ...
            try:
                ...
                if np.count_nonzero((results_array==1) | (results_array==2))>=4:
                    icon = pygame.image.load('/home/justin/Downloads/FYP_icons/traffic2.png')
                    display.blit(icon, (930, 800))    
                    pygame.display.set_icon(icon) 
                        
                elif np.count_nonzero((results_array==0) | (results_array==3))>=4:
                        icon = pygame.image.load('/home/justin/Downloads/FYP_icons/notraffic2.png')
                        display.blit(icon, (930, 800))    
                        pygame.display.set_icon(icon) 
                         
                else : 
                        icon = pygame.image.load('/home/justin/Downloads/FYP_icons/loading2.png')
                        display.blit(icon, (930, 800))    
                        pygame.display.set_icon(icon) 
            ...
            if (parking==1):
                ...
                with open('/home/justin/Documents/parking/1.csv', 'a') as f:
                    writer = csv.writer(f)
                ...
                saved_points = [steer,throttle,brake,reverse,speed]
                with open('/home/justin/Documents/noparking/1.csv', 'a') as f:
                    writer = csv.writer(f)
                    writer.writerow(saved_points)
