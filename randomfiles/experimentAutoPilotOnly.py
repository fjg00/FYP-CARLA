...
#Jason
    ...
    def parse_events(self, client, world, clock):
        ...
        if (throttleCmd != 0 and self._autopilot_enabled == True):
            self._autopilot_enabled = False
            world.player.set_autopilot(self._autopilot_enabled)
            file1 = open('/home/justin/Desktop/carla/ExperimentData/D4.3.txt', 'a')
...
def game_loop(args):
    ...
    try:
        ...
        tm.vehicle_percentage_speed_difference(world.player,-10)
        ...
        hud = HUD(args.width, ar                                 gs.height)
...
##################################################################################################################################################################################################################################### ICONS CODE(FYP)
            ...
            if ((now - begin1)>10 and controller._autopilot_enabled == False ):
                    try:
