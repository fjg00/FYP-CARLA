...
##################################################################################################################################################################################################################################### ICONS CODE(FYP)
            ...
            #         yaxis =[]
            #         speedo2 = []
            #         for i in range(len(timo)-1,len(timo)-200,-1):
            #             xaxis.append(timo[i]-s)
            #             one.append(1)
            #             zero.append(0)
            #             yaxis.append(brako[i])
            #             speedo2.append(speedo[i]/50)
            #         plt.plot(xaxis,yaxis,label="pedal input", )
            #         plt.plot(xaxis,zero)
            #         plt.plot(xaxis,speedo2,'r',label="speed/50")
            #         plt.plot(xaxis,one, 'g')
            #         plt.legend()
